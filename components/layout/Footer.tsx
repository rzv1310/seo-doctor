            ...
            <ul className="space-y-2 text-sm text-text-secondary -ml-6 sm:ml-0">
              {contactInfo.email && (
                <li className="flex items-start gap-2 pl-6 sm:pl-0">
                  ...
                  <a href={`mailto:${contactInfo.email}`} className="hover:text-white hover:underline transition-colors break-all p-0"
                    style={{
                        padding: 0,
                    }}
                  >
              ...
              {contactInfo.phone && (
                <li className="flex items-start gap-2 pl-6 sm:pl-0">
                  ...
                  <a href={`tel:${contactInfo.phone.replace(/\s/g, '')}`} className="hover:text-white hover:underline transition-colors p-0"
                    style={{
                        padding: 0,
                    }}
                  >

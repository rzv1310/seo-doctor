            ...
            <ul className="space-y-2 text-sm text-text-secondary">
              {contactInfo.email && (
                <li className="flex items-center gap-2">
                  ...
                  <a href={`mailto:${contactInfo.email}`} className="hover:text-white hover:underline transition-colors">
                    {contactInfo.email}
                  </a>
                </li>
              )}
              {contactInfo.phone && (
                <li className="flex items-center gap-2">
                  ...
                  <a href={`tel:${contactInfo.phone.replace(/\s/g, '')}`} className="hover:text-white hover:underline transition-colors">
                    {contactInfo.phone}
                  </a>
                </li>
              )}

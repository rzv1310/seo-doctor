    ...
    return (
        <section id="testimonials" className="py-10 sm:py-16 md:py-20 bg-dark-blue-lighter relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                <h2 className="text-2xl sm:text-3xl font-bold mb-4">Ce Spun Partenerii Noștri</h2>
                <p className="text-text-secondary text-sm sm:text-base text-center max-w-2xl mx-auto mb-8 sm:mb-16">
                    Rezultate reale de la afaceri care au ales pachetele SEO Doctor
                </p>
                        ...
                        <div key={testimonial.id} className="dashboard-card p-6">
                            <div className="flex justify-center mb-4">
                                <div className="flex text-white relative">
                                    <span className="absolute -inset-1 bg-white opacity-20 blur-md -z-10"></span>

                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            className={`w-full px-4 py-2 bg-dark-blue border rounded-md focus:outline-none focus:ring-1 ${errors.name ? 'border-danger focus:ring-danger' : 'border-border-color focus:ring-primary'
                                }`}
                        />
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            className={`w-full px-4 py-2 bg-dark-blue border rounded-md focus:outline-none focus:ring-1 ${errors.email ? 'border-danger focus:ring-danger' : 'border-border-color focus:ring-primary'
                                }`}
                        />
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            className={`w-full px-4 py-2 bg-dark-blue border rounded-md focus:outline-none focus:ring-1 ${errors.phone ? 'border-danger focus:ring-danger' : 'border-border-color focus:ring-primary'
                                }`}
                        />
                    ...
                    <div className="mb-4">
                        ...
                        <select
                            ...
                            onChange={handleChange}
                            className={`w-full px-4 py-2 bg-dark-blue border rounded-md focus:outline-none focus:ring-1 ${errors.subject ? 'border-danger focus:ring-danger' : 'border-border-color focus:ring-primary'
                                }`}
                        >
                    ...
                    <div className="mb-6">
                        ...
                        <textarea
                            ...
                            className={`w-full px-4 py-2 bg-dark-blue border rounded-md focus:outline-none focus:ring-1 ${errors.message ? 'border-danger focus:ring-danger' : 'border-border-color focus:ring-primary'
                                }`}
                        ></textarea>

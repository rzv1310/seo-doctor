...
export default function LandingPage({ isAuthenticated = false }: { isAuthenticated?: boolean }) {
  return (
    <div className="min-h-screen bg-dark-blue flex flex-col">
      ...
      {/* Hero section */}
      <section className="py-32 min-h-[80vh] flex-1 flex flex-col items-center justify-center text-center px-4 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-6 relative text-white">
          ...
          <p className="text-text-secondary text-xl max-w-2xl mb-12 drop-shadow">
      ...
      <section id="features" className="py-20 bg-dark-blue-lighter relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <h2 className="text-3xl font-bold text-center mb-8">Serviciile Noastre</h2>
          <p className="text-text-secondary text-center max-w-3xl mx-auto mb-16">
      ...
      <section id="pricing" className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <h2 className="text-3xl font-bold text-center mb-4">Pachete și Prețuri</h2>
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center max-w-3xl relative z-10">
          <h2 className="text-3xl font-bold mb-6">Gata să creșteți vizibilitatea online?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#features" className="text-text-secondary hover:text-primary transition-colors">GBP MAX</a></li>
                <li><a href="#features" className="text-text-secondary hover:text-primary transition-colors">Google Organic</a></li>
                <li><a href="#pricing" className="text-text-secondary hover:text-primary transition-colors">Pachete și Prețuri</a></li>
                <li><a href="#testimonials" className="text-text-secondary hover:text-primary transition-colors">Testimoniale</a></li>
              </ul>
            </div>

            <div>
              <h3 className="text-lg font-semibold mb-4">Resurse</h3>
              <ul className="space-y-2">
                <li><a href="#" className="text-text-secondary hover:text-primary transition-colors">Ghid GBP</a></li>
                <li><a href="#" className="text-text-secondary hover:text-primary transition-colors">Blog SEO</a></li>
                <li><a href="#" className="text-text-secondary hover:text-primary transition-colors">Suport</a></li>
                <li><a href="#" className="text-text-secondary hover:text-primary transition-colors">Studii de Caz</a></li>
              </ul>
            </div>

            <div>
              <h3 className="text-lg font-semibold mb-4">Companie</h3>
              <ul className="space-y-2">
                <li><a href="#" className="text-text-secondary hover:text-primary transition-colors">Despre Noi</a></li>
                <li><a href="#" className="text-text-secondary hover:text-primary transition-colors">Cariere</a></li>

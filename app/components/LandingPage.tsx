...
export default function LandingPage({ isAuthenticated = false }: { isAuthenticated?: boolean }) {
    ...
    return (
        <div className="min-h-screen bg-dark-blue flex flex-col">
            ...
            <header className="py-4 sm:py-6 border-b border-border-color relative backdrop-blur-sm bg-dark-blue bg-opacity-90 sticky top-0 z-50 overflow-visible">
                ...
                <div className="container mx-auto px-4 sm:px-6 flex justify-between items-center relative z-10">
                    ...
                    <div className="md:hidden flex items-center">
                        <button
                            className="flex items-center justify-center w-10 h-10 text-text-primary hover:text-primary transition-colors mobile-menu-button z-50"
                ...
                <div
                    className={`mobile-menu absolute top-full left-0 w-full max-h-[80vh] overflow-y-auto bg-dark-blue-lighter border-b border-border-color backdrop-filter backdrop-blur-xl bg-opacity-80 md:hidden z-40 ${mobileMenuOpen ? 'visible' : 'invisible pointer-events-none'}`}
                >
            ...
            {/* Services section */}
            <section id="features" className="py-12 sm:py-16 md:py-20 bg-dark-blue-lighter relative overflow-hidden">
            ...
            <section id="testimonials" className="py-12 sm:py-16 md:py-20 bg-dark-blue-lighter relative overflow-hidden">
            ...
            <section className="py-12 sm:py-16 md:py-20 relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 text-center max-w-3xl relative z-10">
                    <h2 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6">Gata să creșteți vizibilitatea online?</h2>
                    <p className="text-text-secondary mb-6 sm:mb-8 text-base sm:text-lg md:text-xl">
                        Alăturați-vă sutelor de afaceri care au ales serviciile noastre de optimizare pentru Google.
                    </p>
                    <Link
                        href={isAuthenticated ? "/dashboard" : "/login"}
                        className="bg-gradient-to-r from-primary to-primary-dark text-white text-base sm:text-lg font-medium rounded-full px-8 sm:px-10 py-3 sm:py-3.5 transition-all inline-block shadow-lg shadow-primary/30 hover:shadow-xl hover:shadow-primary/40 relative group overflow-hidden w-full sm:w-auto max-w-xs mx-auto"
                    >
                        <span className="relative z-10 flex items-center justify-center gap-2">
                            {isAuthenticated ? "Accesează Profil" : "Începe Acum"}
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 mb-8">
                        ...
                        <div className="mb-6 sm:mb-0">
                            ...
                            <ul className="space-y-2">
                                <li><a href="#" className="text-text-secondary hover:text-primary transition-colors text-sm sm:text-base">Ghid GBP</a></li>
                                <li><a href="#" className="text-text-secondary hover:text-primary transition-colors text-sm sm:text-base">Blog SEO</a></li>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                ...
                                <li><a href="#" className="text-text-secondary hover:text-primary transition-colors text-sm sm:text-base">Cariere</a></li>

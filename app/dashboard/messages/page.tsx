    ...
    return (
        <>
            ...
            <div className="flex gap-0 flex-1 min-h-0 relative messages-container" style={{ gap: '0' }}>
                {/* User list */}
                <div
                    className={`dashboard-card flex flex-col transition-all duration-300 user-list-responsive ${
                        showUserList ? 'show-list' : ''
                    }`}
                >
                            ...
                            userChats.map((chat) => (
                                ...
                                >
                                    ...
                                    >
                                        <div className="flex justify-between items-start mb-1">
                                            <h3 className={`font-medium truncate pr-2 ${
                                                selectedUser === chat.userId ? 'text-text-primary' : 'group-hover:text-primary'
                                            }`}>
                                                {chat.userName}
                                            </h3>
                                    ...
                                    <div className={`absolute right-4 top-1/2 -translate-y-1/2 transition-opacity ${
                                        selectedUser === chat.userId ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'
                                    }`}>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <p className={`text-xs mt-1 ${
                                                message.isFromAdmin ? 'text-white/70' : 'text-text-primary'
                                            }`}>

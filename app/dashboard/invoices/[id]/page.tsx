  ...
  return (
    <>
      <div className="mb-6 flex flex-col md:flex-row md:items-center md:justify-between">
        <div>
          <h1 className="text-2xl font-bold mb-2">Factura {invoice.id}</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
        ...
        <div className="dashboard-card p-4">
          ...
          <div className="text-xl font-bold text-primary">{formatPrice(invoice.amount)}</div>
        </div>
        <div className="dashboard-card p-4">
              ...
              <tbody className="divide-y divide-border-color">
                {invoice.items.map((item, index) => (
                  <tr key={index}>
                    ...
                    <td className="px-4 py-4 whitespace-nowrap text-sm">{formatPrice(item.unitPrice)}</td>
                    <td className="px-4 py-4 whitespace-nowrap text-sm">{formatPrice(item.total)}</td>
                  </tr>
                ))}
          ...
          <div className="mt-6 flex justify-end">
            <div className="w-full max-w-xs">
              ...
              <div className="flex justify-between py-3 font-bold">
                <span>Total</span>
                <span className="text-primary">{formatPrice(invoice.amount)}</span>
              </div>
            </div>
          </div>
        </div>

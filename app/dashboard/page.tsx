        ...
        {stats.map((stat, index) => (
          ...
          >
            ...
            <div className="flex items-end justify-between mt-4">
              <div className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-br from-primary to-accent">{stat.value}</div>
              ...
              <tbody className="divide-y divide-border-color">
                {recentOrders.map((order, idx) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-4 whitespace-nowrap text-sm text-text-secondary">{order.date}</td>
                    <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-primary">{order.amount}</td>
                ...
                {expiringServices.map((service, idx) => (
                  ...
                  >
                    <div className="flex-1">
                      ...
                      <div className="text-text-secondary text-sm mt-1 flex items-center">
                    ...
                    <div className="text-right ml-4">
                      <div className="font-bold text-accent">{service.price}/mo</div>
                      <div className={`mt-1 px-3 py-1 rounded-full text-xs font-medium inline-flex items-center
                        ${service.daysLeft < 5 
